...
6. Zero hallucination — if unsure about any fact/API/package, WebSearch first
7. Time-sensitive info — always search internet, never rely on training data alone
</user-prompt-submit-hook>
EOF
